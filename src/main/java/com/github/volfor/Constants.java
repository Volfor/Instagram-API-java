...
class Constants {
    ...
    public static final String USER_AGENT = String.format(
            "Instagram 10.3.2 Android (%s/%s; 320dpi; 720x1280; %s; %s; armani; qcom; en_US)",
            ANDROID_VERSION, ANDROID_RELEASE, MANUFACTURER, MODEL
    );

    public static final String IG_SIG_KEY = "5ad7d6f013666cc93c88fc8af940348bd067b68f0dce3c85122a923f4f74b251";
    ...
    public static String getDeviceSetting() {
        ...
        deviceSettings.addProperty("android_version", ANDROID_VERSION);
        deviceSettings.addProperty("android_release", ANDROID_RELEASE);
        deviceSettings.addProperty("manufacturer", MANUFACTURER);
        deviceSettings.addProperty("model", MODEL);

        return deviceSettings.toString();
    }
