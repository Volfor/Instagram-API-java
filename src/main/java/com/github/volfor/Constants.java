...
class Constants {
    ...
    public static final int ANDROID_VERSION = 18;
    public static final String ANDROID_RELEASE = "4.3";
    public static final String MANUFACTURER = "Xiaomi";
    public static final String MODEL = "HM 1SW";

    public static final String USER_AGENT = String.format(
            "Instagram 9.2.0 Android (%s/%s; 320dpi; 720x1280; %s; %s; armani; qcom; en_US)",
            ANDROID_VERSION, ANDROID_RELEASE, MANUFACTURER, MODEL
    );

    public static final String IG_SIG_KEY = "012a54f51c49aa8c5c322416ab1410909add32c966bbaa0fe3dc58ac43fd7ede";
    ...
    public static String getDeviceSetting() {
        Json deviceSettings = new Json.Builder()
                .put("android_version", ANDROID_VERSION)
                .put("android_release", ANDROID_RELEASE)
                .put("manufacturer", MANUFACTURER)
                .put("model", MODEL)
                .build();

        return deviceSettings.toJSONString();
    }
